  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          data?.error || "Unable to submit accommodation request"
        );
      }
        ...
        <form className="space-y-8" onSubmit={handleSubmit} noValidate>
          <div className="space-y-3 text-center">
            ...
            <p className="text-sm text-gray-500 sm:text-base">
              Please provide your details to request accommodation for the
              event.
            </p>
          </div>
                ...
                <input
                  ...
                  aria-describedby={
                    fieldHasError("ipcRegistrationNumber")
                      ? "ipcRegistrationNumber-error"
                      : undefined
                  }
                />
                {fieldHasError("ipcRegistrationNumber") && (
                  <p
                    id="ipcRegistrationNumber-error"
          ...
          {status === "success" && (
            <p className="rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-sm text-[var(--primary-green,#008080)] shadow-sm">
              Thanks! We&apos;ve received your accommodation request. We will
