  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={handleClose}
        className="absolute right-6 top-6 z-[110] flex h-11 w-11 items-center justify-center rounded-full bg-white/90 text-2xl font-semibold text-gray-700 shadow-lg transition hover:bg-white"
