...
import KitDeliveryForm from "@/components/CertificateForm";

export const metadata: Metadata = {
    title: "Request Kit Delivery - 74th IPC Pharma Expo",
    description:
        "Request your delegate kit to be couriered to your home address. Please provide your registration details and delivery address.",
};
                ...
                <div className="space-y-8">
                    ...
                    <div className="rounded-2xl border border-blue-100 bg-blue-50 p-6 text-sm text-blue-800">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            ...
                            <li>Delegate kit will be couriered to your home address.</li>
